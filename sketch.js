...
function setup() 
{
 ...
 // bk_song.play();
  ...
  score= createSprite(50,30,40,40);
  score.addImage(emptyStars);
  score.addAnimation('one_star',oneStar);
  score.addAnimation('two_star',twoStar);
  score.scale=0.2;
...
function draw() 
{
  ...
  if(collide(fruit,star1,20)== true){
    star1.visible = false;
    score.changeAnimation('one_star');
  }
  if(collide(fruit,star2,20)== true){
    star2.visible = false;
    score.changeAnimation('two_star');
  }
}
